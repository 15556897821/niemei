...
3. 在建立issue的时候，在右边有个**Assignee**，可以指派仓库里的其他成员做这个issue。  
...
7. 如果你想引用到同一个仓库中的一个Issue，只需使用#加上跳转的issue序号，这样就会自动创建到此Issue的链接。要链接到其他仓库的Issue，就使用user_name/repo_name#ISSUE_序号 的方式。 
 例如： outliergg/123#1
