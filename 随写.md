1. issue：在里程碑里进行issue的部署可以建立多个问题，解决也相当版本开发结束，里程碑结束  
...
## 版本回退：
1. 在网页端，没有直接回退的功能，只能通过文档的历史记录，找到之前用的版本，点击浏览，相当于进到那个时间段的仓库，再建立分支，才能修改这个旧的文档。
2. 在本地客户端上，可以实现版本回退功能，直接在历史记录点击过去版本，进行上传，就回退到之前的版本。
